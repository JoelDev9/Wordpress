...
(function($) {
    ...
    $.redux.wbc_importer = function() {
        ...
        $('.wrap-importer.theme.not-imported, #wbc-importer-reimport').unbind('click').on('click', function(e) {
            ...
            var message = 'Import Demo Content? This will overwrite your current posts, pages, configurations, options, images etc.';

            if (e.target.id == 'wbc-importer-reimport') {
                reimport = true;
                message = 'Re-Import Content? Import Demo Content? This will overwrite your current posts, pages, configurations, options, images etc.';
