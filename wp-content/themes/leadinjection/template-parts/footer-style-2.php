...
<footer id="colophon" class="li-footer li-footer-style-2">
        ...
        <div class="footer-widget-bar footer-row">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-4">
                        <div class="footer-widget">
                            <?php if (is_active_sidebar('footer-widget-bar-col4')) {
                                if (function_exists('dynamic_sidebar') && dynamic_sidebar('Footer 4 column')) : ?>
                            <?php endif;
                            } ?>
                        </div>
                    </div>
